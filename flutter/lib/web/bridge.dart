...
class RustdeskImpl {
  ...
  Future<String> mainGetServerProvider({dynamic hint}) {
    throw UnimplementedError("mainGetServerProvider");
  }

  Future<String> mainGetServerProviderState({dynamic hint}) {
    throw UnimplementedError("mainGetServerProviderState");
  }

  Future<String> mainGetServerProviderConfig(
      {required String serverProvider, dynamic hint}) {
    throw UnimplementedError("mainGetServerProviderConfig");
  }
  ...
  Future<void> mainSetServerProvider(
      ...
      dynamic hint}) {
    throw UnimplementedError("mainSetServerProvider");
  }

  Future<String> mainDetectServerProvider(
      {required String customConfig, dynamic hint}) {
    throw UnimplementedError("mainDetectServerProvider");
  }
